...
def main(job_id, params):
    ...
    cmd = 'cd /home/user/pdeboer/PPLib && sbt "run-main ch.uzh.ifi.pdeboer.pplib.examples.optimization.MCOptimize /home/user/pdeboer/bo/Spearmint/examples/noisyPPLib_1,1,1,97_tal/jobdesc_'+str(job_id)+'.txt answers1,1,1,97"'
