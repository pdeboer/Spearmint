...
def main(job_id, params):
    ...
    cmd = 'cd /home/user/pdeboer/PPLib && sbt "run-main ch.uzh.ifi.pdeboer.pplib.examples.optimization.MCOptimize /home/user/pdeboer/bo/Spearmint/examples/noisyPPLib_24,24,24,28_tal/jobdesc_'+str(job_id)+'.txt answers24,24,24,28"'
